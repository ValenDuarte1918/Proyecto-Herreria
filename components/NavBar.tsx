...
const NavBar = ({ className }: { className?: string }) => {
      return (
          <div className={`flex flex-col w-[1507px] h-[120px] items-end justify-center gap px-12 py-[3px] relative bg-white shadow-[0px_3px_11px_#00000040] ${className}`}>
              <div className="relative w-[847px] h-[1120px] mt-[-1.50px] mb-[-1.50px] z-[1]">
              ...
              <div className="inline-flex flex-col h-[105px] items-center justify-around gap-[10px] absolute top-[3px] left-[82px] z-0">
